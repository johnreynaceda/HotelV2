            ...
            <li class="flex py-2 px-2">
              ...
              <div class="ml-2">
                <div class="flex space-x-1">
                  ...
                  <p class="text-sm text-gray-900 ">{{ $guest->contact != 'N/A' ? '(09' . $guest->contact . ')' : ''}}</p>
                </div>
        ...
        <div class="border rounded-lg p-5">
          ...
          <span class="font-bold text-gray-600  text-lg mb-4">Paid Bills</span>
            <dl class="mt-8 divide-y divide-gray-200 text-sm mb-4 border-b-2 border-dashed lg:col-span-5 lg:mt-0">
              ...
              @endforeach
              @php 
                $total_paid = $transaction_bills_paid->filter(function($bill) {
          ...
          <span class="font-bold text-gray-600  text-lg mb-4">Unpaid Bills</span>
            <dl class="mt-8 divide-y divide-gray-200 text-sm mb-4 border-b-2 border-dashed lg:col-span-5 lg:mt-0">
              ...
              @endforeach
              @php 
                $total_payable = $transaction_bills_unpaid->filter(function($bill) {
              ...
              @if($total_payable > 0)
                ...
                <div class="py-3">
                  <x-button full label="Pay all with deposit" amber wire:click="payAllWithDeposit({{ $total_payable }})" />
                </div>
                </div>
                @else
                <div class="py-3">
            ...
            <dl class="mt-8 divide-y divide-gray-200 text-sm mb-4 border-b-2 border-dashed lg:col-span-5 lg:mt-0">
              ...
              <div class="flex items-center justify-between py-2">
                ...
                <dd class="font-medium text-indigo-600">₱{{number_format(($check_in_details->total_deposit - $check_in_details->total_deduction), 2)}}</dd>
              </div>
