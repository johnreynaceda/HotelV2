...
<div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 mt-2 md:rounded-lg">
          <table class="min-w-full divide-y divide-gray-300">
            <thead class="bg-gray-50">
              <tr>
                <th scope="col" class="whitespace-nowrap py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Room Number</th>
                <th scope="col" class="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-gray-900">Floor</th>
          ...
          <div class="flex min-w-0 flex-1 items-center">
            ...
            <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
              <div>
                ...
                <svg class="mr-1.5 w-5 h-5" xmlns=" http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <div class="hidden md:block">
                ...
                {{ \Carbon\Carbon::parse($kiosk->created_at)->format('F d, Y g:iA') }}
                  ...
                  <p class="mt-2 flex items-center text-sm text-gray-500">
                    ...
                    <svg class="mr-1.5 w-5 h-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
