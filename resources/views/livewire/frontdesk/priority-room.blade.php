<div>
  <div class="grid grid-cols-2 gap-10">
    <div>
      ...
      <div class="mt-3 grid grid-cols-3 gap-4" x-animate>
        @forelse ($priority_rooms as $room)
          <div class="rounded-lg bg-gradient-to-br relative from-gray-300 overflow-hidden p-5 via-gray-200 to-gray-100">
