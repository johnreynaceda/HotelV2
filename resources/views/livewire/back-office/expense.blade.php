<div>
  <div class="flex justify-end space-x-2 px-4">
    ...
    <x-button label="Add New" icon="plus" positive />
  </div>
  <div class="table w-full px-4">
    <div class=" bg-white p-4 rounded-xl mt-4">
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-xl font-semibold text-gray-600">Total Expenses</h1>
          <p class="mt-2 text-sm text-gray-700">&#8369; 100,000.00</p>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-300">
          ...
          <tbody>
            @forelse ($categories as $category)
              <tr>
                <th colspan="3" class="bg-gray-200 text-left font-semibold uppercase text-gray-700 p-2">
                  {{ $category->name }}</th>
              </tr>
