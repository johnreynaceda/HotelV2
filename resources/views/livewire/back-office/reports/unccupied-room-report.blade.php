  ...
  <div>
    ...
    <div x-ref="printContainer">
      ...
      <div class="flex mt-10 justify-center">
        <h1 class="font-bold text-xl ">UNOCCUPIED ROOM REPORT</h1>
      </div>
      <div class="mt-6">
        <table id="example" class="mt-2 table-auto" style="width:100%">
          <thead class="font-normal">
            <tr>
              <th class="px-2 py-2 w-40  border-gray-700 text-sm font-semibold text-left text-gray-700 border">DATE
              </th>
              <th class="px-2 py-2  border-gray-700  text-sm font-semibold text-left text-gray-700 border">
                UNOCCUPIED
                ROOMS
              </th>
              <th class="px-2 py-2 w-64 border-gray-700 text-sm font-semibold text-left text-gray-700 border">FRONTDESK
                NAME
              </th>
            </tr>
          </thead>
          <tbody class="">
            ...
            @foreach ($unoccupied_rooms as $item)
              <tr>
                <td class="px-3 border-gray-700 py-1  border">
                  {{ \Carbon\Carbon::parse($item->created_at)->format('F d, Y h:i A') }}</td>
                <td class="px-3 border-gray-700 py-1 break-all border">
                  <p class="break-all text-justify">{{ $item->rooms }}</p>
                </td>
                <td class="px-3 border-gray-700
                    py-1 border">
                  @php
